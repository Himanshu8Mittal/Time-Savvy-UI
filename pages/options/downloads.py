...
def show_downloads(user_profile):
    ...
    if "df2_d" in st.session_state:
        ...
        header_height = 32  # Approximate header height in pixels
        buffer_height = 30  # Additional buffer height for padding
        ...
        AgGrid(
            ...
            height=grid_height,
            key="timesheet_grid_download",  # Ensure unique key for the AgGrid component
        )
